...
class MarsAPI:
    ...
    def send_message(
        ...
        try:
            ...
            return {"success": True, "response": response, "sessionId": sid, "error": None}
        except Exception as e:
            return {"success": False, "response": None, "sessionId": None, "error": str(e)}
    
    def list_messages(self, session_id: Optional[str] = None, limit: Optional[int] = None) -> dict:
